...
--
-- Хост: localhost
-- Время создания: Мар 23 2012 г., 17:53
...
(32, 7, 'Правіць профіль', 'Редактировать профиль', 'Redaktirovanie_profilya.php', 0, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Комментарии к новостям' AUTO_INCREMENT=7 ;
...
(1, 'FutureCMS', '<p>FutureCMS</p> by Sobko Andrey', '© FutureCMS Sobko Andrey 2010-2012', 'FutureCMS1', 'FutureCMS1', 'FutureCMS1', 'utf-81'),
